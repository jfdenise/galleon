...
public class FeaturePackFamilyMissingOverridesTestCase extends LayoutOrderingTestBase {
    ...
    @Override
        ...
        String[] errors = {"The feature-pack org.jboss.galleon.test:fp1:1.0.0.Final expects the dependency on org.jboss.galleon.test:dep-family-fp1:1.0.0.Final but this dependency is of the family family1 for which a different member org.jboss.galleon.test:dep-family-fp2:1.0.0.Final is in use."};
        return errors;
    }
