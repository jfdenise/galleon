...
public class AdvancedTransitiveFeaturePackFamilyTestCase extends LayoutOrderingTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        ...
        builder3.addDependency(FeaturePackConfig.builder(fpl1, false, true).build());
        ...
        builder4.addDependency(FeaturePackConfig.builder(fpl2, false, true).build());
        ...
        builder5.addDependency(FeaturePackConfig.builder(fpl3, false, true).build());
        builder5.setFamily("topFamily");
        ...
        builder6.setFamily("topFamily");
        builder6.addDependency(FeaturePackConfig.builder(fpl4, false, true).build());
        ...
        builder7.addDependency(FeaturePackConfig.builder(fpl5, false, true).build())
                .addTransitiveDependency(fpl3, true)
                .addTransitiveDependency(fpl1, true);
    }
