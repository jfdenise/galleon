...
public class FPLFamilyExcludePackageTransitiveTestCase extends ProvisionFromUniverseTestBase {
    ...
    protected void createFeaturePacks(FeaturePackCreator creator) throws ProvisioningDescriptionException {
        fpl1 = newFpl("ee10-gal", "1", "1.0.0.Final");
        ...
        fpl2 = newFpl("ee11-gal", "1", "1.0.0.Final");
        ...
        fpl3 = newFpl("cloud-gal", "1", "1.0.0.Final");
        FeaturePackBuilder builder3 = creator.newFeaturePack(fpl3.getFPID());
        builder3.addDependency("foo-origin", FeaturePackConfig.builder(toMavenCoordsFpl(fpl1)).
                setAllowedFamily("family1:specific1").setInheritPackages(false).excludePackage("p4").includePackage("p5").build());
