...
public class FeaturePackConfig extends ConfigCustomizations {
    ...
    public static class Builder extends ConfigCustomizationsBuilder<Builder> {
        ...
        protected boolean familyMemberAllowed;
        ...
        protected Builder(FeaturePackLocation fpl, Boolean inheritPackages, boolean transitive) {
           this(fpl, inheritPackages, transitive, false);
        }

        protected Builder(FeaturePackLocation fpl, Boolean inheritPackages, boolean transitive, boolean familyMemberAllowed) {
            this.fpl = fpl;
            this.inheritPackages = inheritPackages;
            this.transitive = transitive;
            this.familyMemberAllowed = familyMemberAllowed;
        }
        ...
        public Builder setFamilyMemberAllowed(boolean familyMemberAllowed) {
            this.familyMemberAllowed = familyMemberAllowed;
            return this;
        }
    ...
    public static Builder builder(FeaturePackLocation fpl, boolean inheritPackages, boolean familyMemberAllowed) {
        return new Builder(fpl, false, inheritPackages, familyMemberAllowed);
    }
    ...
    public static FeaturePackConfig forTransitiveDep(FeaturePackLocation fpl, boolean familyMemberAllowed) {
        return new Builder(fpl, null, true).setFamilyMemberAllowed(familyMemberAllowed).build();
    }
    ...
    protected FeaturePackConfig(Builder builder) {
        ...
        this.familyMemberAllowed = builder.familyMemberAllowed;
    ...
    public boolean isFamilyMemberAllowed() {
        return familyMemberAllowed;
    }
