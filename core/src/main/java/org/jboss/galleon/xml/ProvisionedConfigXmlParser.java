...
public class ProvisionedConfigXmlParser implements XmlParser<ProvisionedConfig> {
    ...
    public static ProvisionedConfig parse(Path p) throws ProvisioningException {
        return parse(p, new DefaultMessageWriter());
    }

    public static ProvisionedConfig parse(Path p, MessageWriter writer) throws ProvisioningException {
    ...
    @Override
    public ProvisionedConfig parse(Reader input, MessageWriter writer) throws XMLStreamException, ProvisioningDescriptionException {
