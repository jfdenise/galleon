...
class GalleonProvisioningLayoutImpl implements GalleonProvisioningLayout {
    ...
    public <T extends ProvisioningPlugin> void visitPlugins(FeaturePackPluginVisitor<T> visitor, String clazz) throws ProvisioningException {
        ...
        layout.visitPlugins(visitor, (Class<T>) loadedClass);
    }
